...
from vtb_code.data import PairedDataset, PairedZeroDataset, DropDuplicate, paired_collate_fn
...
def train_qsm(df_matching_train, features_trx_train, features_click_train):
    batch_size = 128
...
def main():
    ...
    train_qsm(df_matching_train, features_trx_train, features_click_train)
